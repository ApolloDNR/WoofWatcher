...
- `pnpm run test:focused` passed **797/797** on Node 24.14.0 with pnpm 10.24.0.
- `pnpm run build:ci` passed all workspace typechecks/builds, a 274-file Expo web export, all 13 runtime routes, and live-preview proof.
