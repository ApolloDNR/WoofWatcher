...
- [x] A4. Legal documents drafted: `docs/legal/PRIVACY_POLICY.md` and `docs/legal/TERMS_OF_SERVICE.md`, accurate to the local-first v1 reality, with [BRACKETED] placeholders only Apollo can fill (support email, legal entity name, jurisdiction, effective dates).
...
- [ ] C1. Fill every [BRACKETED] placeholder in `docs/legal/PRIVACY_POLICY.md` and `docs/legal/TERMS_OF_SERVICE.md`: legal entity name (is "Pegasus Dreamscapes" the registered entity?), support email, jurisdiction, effective dates. A quick lawyer review pass is recommended before hosting.
