...
- PixelLab secret hygiene. A PixelLab bearer token was visible in a screenshot on 2026-06-17, so it should stay revoked/regenerated and never be committed. PixelLab MCP is now callable in Codex, Apollo has an active subscription, and Phoenix v2 seed/state plus idle, tail-wag, sleep-loop, and day dogless room assets have been generated locally. Remaining asset blockers are room variants, remaining action strips, and final visual approval, not MCP access.
