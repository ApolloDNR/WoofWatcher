...
4. Add the next richer Mood & Energy review layer, such as caregiver/context visual refinement or final report/PDF export polish, without diagnostic claims.
