...
3. Continue production-scale Avatar Studio packs: remaining non-Retriever/body-class emotes, sprite strips, and true overlay-aligned accessory layers.
