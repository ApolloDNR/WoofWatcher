...
3. Continue production-scale Avatar Studio template packs: shepherd sprite strips that match the new still pack, then overlay layers, emote stills, and body-class sprite strips for Retriever, Husky, Bully, Doodle, and the remaining launch templates.
