...
4. Add the next richer local report/Records trust layer, such as report-prep refinement or credential export history, without claiming provider-backed storage, PDF generation, cloud sharing, or unsupervised assistant actions.
