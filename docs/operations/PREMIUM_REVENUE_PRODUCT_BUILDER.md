...
As of 2026-06-11, the current queue points to mobile runtime QA and premium polish: native simulator/device smoke, full accessibility pass, visual regression, App Store prep, premium design/motion, deeper multi-device conflict policy, provider-backed notification delivery, report export hardening, medication search/filters, water goal customization, hydration trends, saved walk routes/maps, dog park templates, formal training plans, Alone Time trigger plans, richer Weight Trend plans, grooming reminders, potty trend history, accident/urgency follow-up workflows, and stricter medication scheduling. CI-safe static route/safety smoke, critical action screen-reader label smoke, Expo web export smoke, Free/Plus/Family entitlement policy, release-grade Expo app identity, a tested Home avatar motion state model, durable sync outbox derivation, Log recovery banner, Full Log search, More Sync Health dashboard, Household Responsibility Center, Household Access, Reminder Center with row action routing, Care Log Audit Trail, conflict-safer care-document refresh, print-ready Care Pass artifact HTML, Records report-history print-source sharing, printable Dog ID credential source, medication adherence status, medication-specific log defaults, Medication Follow-ups, Medication History, Home water quick logs, shared daily hydration summaries, Records Hydration UI, Home walk quick-log visibility, shared Walk Activity summaries, Saved Routes templates, Records Walk Activity/Saved Routes UI, weekly Care Trends, structured Training Progress, structured Alone Time tracking, Records Alone Time UI, shared Weight Trend derivation, Records Weight Trend chart inputs, structured Grooming Care logging, Records Grooming Care UI, Home potty quick-log visibility, potty stool color/context capture, shared Potty Health summaries, Records Potty Health UI, and Care Pass walk/hydration/training/alone-time/weight/grooming/potty/medication/trend report language exist, but native rendering, screen-reader traversal, screenshots, final Rive/Lottie/Reanimated assets, binary PDF generation, real push notifications, provider-backed role enforcement, server-backed report storage, EAS/App Store credentials, and real checkout remain blocked.
