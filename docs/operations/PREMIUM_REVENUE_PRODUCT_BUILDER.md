...
4. Add the next richer local report/Records trust layer, such as credential export polish or report-prep refinement, without claiming provider-backed storage, PDF generation, cloud sharing, or unsupervised assistant actions.
