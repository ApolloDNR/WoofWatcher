...
3. Provider-backed household invite approval/acceptance, Access Pass activation/enforcement, helper audit trails, and caregiver editing.
...
- Expand role-aware authorization beyond the new care-entry write policy and household role mutation/revocation API contracts into provider-backed invite acceptance, Access Pass activation/enforcement, helper audit trails, and account-action audit events.
