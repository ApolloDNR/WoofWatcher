...
- Add broader role-aware authorization checks beyond basic household membership. Household rename and audit review now have owner/admin guards, but invite approval, caregiver editing, audit event producers, document access, role changes, and other sensitive account/household actions still need provider-backed policy.
