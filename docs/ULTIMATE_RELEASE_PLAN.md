...
- Add broader role-aware authorization checks beyond basic household membership. Household rename now has an owner/admin guard, but invite approval, caregiver editing, document access, role changes, and other sensitive account/household actions still need provider-backed policy.
