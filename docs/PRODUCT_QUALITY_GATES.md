...
- Records and WoofGuide saved-report review now reuse `summarizeReportArtifacts.approvalLine`, so owners are told to choose the handoff audience and approve the local source content before sharing a reusable local Care Pass, Progress Report, or Dog ID source.
