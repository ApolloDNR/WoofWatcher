...
- Calendar exposes Reminder Center derived from routine-board status, medication follow-ups, record reminders, and grooming due dates, with urgency counts and explicit notification-readiness copy before provider-backed push delivery exists.
...
- Reminder Center derivation, urgency sorting, private-log exclusion through the underlying care helpers, notification-readiness copy, and Calendar wiring are covered by focused tests.
...
Latest known passing CI before the Reminder Center slice:

- Workflow: `WoofWatcher Verify`
- Branch: `main`
- Evidence: run `27367395109`, completed success on 2026-06-11 UTC
