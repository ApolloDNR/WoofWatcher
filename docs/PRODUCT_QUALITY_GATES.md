...
- Mobile More exposes Pack Audit review for the active household. The surface lists recent owner/admin trust events through the generated audit-events hook, shows loading, empty, and offline states, and keeps lifecycle actions provider-gated.
