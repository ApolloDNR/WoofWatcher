...
- Deterministic WoofGuide action-card model and tests exist before action writes are enabled, including owner-reviewed Mood & Energy summaries and Dog ID Prep drafts that reuse shared evidence/readiness helpers without mutating care records.
