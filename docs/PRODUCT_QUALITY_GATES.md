...
Dependency-complete branch CI passed in run `30673093155`, job `91294737029`, for implementation commit `30ee2729`.
...
Dependency-complete branch CI passed in run `30651392273`, job `91225245672`, for implementation commit `a7697cb9`.
...
Dependency-complete branch CI passed in run `30638894339`, job `91183485851`, for implementation commit `08d20c0f`.
...
- Native gate: OPEN until compact-height iOS/Android, date-keyboard, VoiceOver/TalkBack, and route screenshot evidence is captured.
