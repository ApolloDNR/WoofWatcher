...
- Records and WoofGuide saved-report review now reuse `summarizeReportArtifacts.audienceLine`, so owners are told to pick the sitter, trainer, caregiver, or vet audience before resending because each handoff may need different notes.
