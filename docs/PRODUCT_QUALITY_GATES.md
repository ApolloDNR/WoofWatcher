...
- Need full accessibility pass. Critical action screen-reader labels, shared board touch targets, route-local action touch targets, keyboard avoidance, and inline action hit slop are covered by focused static smoke, but contrast, dynamic type, and native screen-reader traversal still need QA.
