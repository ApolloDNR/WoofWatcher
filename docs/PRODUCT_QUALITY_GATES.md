...
- Home quick log can record household-visible potty logs, the Log composer captures pee/poop kind and condition, and Records includes Potty Health derived from visible potty logs, stool review signals, conditions, and caregivers.
...
- Focused tests cover event normalization, day status, care sync, Today Command, setup wizard, diet progress, medication quick-log defaults, medication composer wiring, medication adherence, medication follow-ups, medication history, water quick-log defaults, hydration summaries, hydration Care Pass language, mobile Records hydration wiring, walk quick-log visibility, walk activity summaries, walk activity Care Pass language, mobile Records walk activity wiring, potty quick-log visibility, Potty Health summaries, Potty Health Care Pass language, mobile Records Potty Health wiring, Care Pass medication language, mobile Records medication wiring, health handoff, care pass, Care Pass artifact snapshots, print-ready Care Pass HTML, legacy printable artifact recovery, record vault, pet credential fallbacks, print-ready Dog ID credentials, record due-status, routine board, sticky notes, and WoofGuide action cards.
...
- Potty quick-log visibility, Potty Health summary logic, Care Pass potty health language, and Records Potty Health wiring are covered by focused tests.
