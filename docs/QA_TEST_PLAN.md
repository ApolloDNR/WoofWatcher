...
- Route-local mobile action control touch-target readiness for Plans schedule/routine controls, Calendar event-management controls, ErrorFallback recovery controls, Log search/filter controls, Records medication/report controls, More household/profile controls, Health/Bile, Premium, Setup, and Avatar Studio compact controls.
