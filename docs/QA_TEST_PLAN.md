...
- Split care-plan versus care-log write enforcement, including `PUT /care-state` using owner/admin/member roles and `POST/PATCH/DELETE /care-entries` using owner/admin/member/sitter/trainer roles.
