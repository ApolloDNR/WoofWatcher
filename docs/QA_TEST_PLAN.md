...
- Route-local mobile action control touch-target readiness for Plans schedule/routine controls, Log, Health/Bile, Premium, Setup, and Avatar Studio compact controls.
