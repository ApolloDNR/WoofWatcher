...
4. Deeper route-by-route visual polish now that Records, More, Plans, and the Quick Log search/timeline surfaces have been moved off old local card/header patterns and the remaining core routes have shared board chrome.
