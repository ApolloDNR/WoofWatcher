...
4. Deeper route-by-route visual polish now that Records, More, Plans, Quick Log, and WoofGuide have been moved off the biggest old local card/header patterns and the remaining core routes have shared board chrome.
