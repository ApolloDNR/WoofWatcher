#!/usr/bin/env node
/**
 * QA screenshot sweep: captures every executable consumer route represented by
 * the navigation manifest, plus standalone fast-log/month-calendar screens, at
 * iPhone 390x844 for side-by-side comparison against the locked reference set.
 * Build and serve the exact consumer candidate first:
