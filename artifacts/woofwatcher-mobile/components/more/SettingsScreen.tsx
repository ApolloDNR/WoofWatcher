    ...
    >
      ...
      <BoardCard enter={1}>
        ...
        <Pressable
          ...
          onPress={() => onOpenSection("dog-profile")}
        ...
        <Pressable
          ...
          onPress={() => onOpenSection("avatar-studio")}
          style={[styles.row, { borderColor: colors.border }]}
        >
          <Ionicons
      ...
      <View>
        <Text style={[styles.note, { color: colors.mutedForeground }]}>
          Online account features aren't available in this version. Your care
