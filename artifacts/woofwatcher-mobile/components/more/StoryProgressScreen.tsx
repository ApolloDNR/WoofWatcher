...
export default function StoryProgressScreen({
  onBack,
  onOpenAdventure,
}: StoryProgressScreenProps) {
  ...
  const openAdventure = onOpenAdventure;
  const openWalkLog = () =>
            ...
            <BoardCard style={s.board} enter={1}>
              ...
              <View style={{ gap: 8, marginTop: 12 }}>
                <BoardMetricTile
                  ...
                  value={String(careerWeek.logsThisWeek)}
