...
const styles = StyleSheet.create({
  ...
  dogFocus: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    boxShadow: "0 0 18px rgba(255, 249, 239, 0.38)",
  },
  spriteRig: {
    position: "absolute",
    alignItems: "center",
  ...
  spark: {
    position: "absolute",
    boxShadow: "0 0 8px rgba(255, 249, 239, 0.82)",
  },
  topHud: {
    position: "absolute",
    top: 11,
  ...
  roomStatsPanel: {
    ...
    gap: 7,
    zIndex: 6,
    boxShadow: "0 5px 10px rgba(8, 20, 36, 0.12)",
  },
  roomStatsHeader: {
    flexDirection: "row",
    alignItems: "center",
  ...
  actionSpark: {
    ...
    height: 8,
    borderRadius: 2,
    boxShadow: "0 0 8px rgba(255, 249, 239, 0.9)",
  },
  actionBurstText: {
    fontFamily: "Fredoka_700Bold",
    fontSize: 12,
    ...({ textShadow: "0 1px 4px rgba(8, 26, 42, 0.55)" } as any),
  },
  roomDock: {
    position: "absolute",
    left: 12,
