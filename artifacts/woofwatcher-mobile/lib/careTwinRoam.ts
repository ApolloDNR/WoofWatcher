...
export const IMMERSIVE_ROAM_WAYPOINTS: Record<AvatarRoomZone, RoamWaypoint> = {
  door: { zone: "door", xPct: 3, yPct: 33, scale: 0.99 },
  window: { zone: "window", xPct: 12, yPct: 32, scale: 0.97 },
  rug: { zone: "rug", xPct: 27, yPct: 34, scale: 1 },
  bed: { zone: "bed", xPct: 39, yPct: 33, scale: 1 },
  bowl: { zone: "bowl", xPct: 48, yPct: 35, scale: 1.03 },
};
