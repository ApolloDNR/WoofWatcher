...
export const RECORDED_MOBILE_BETA_CI_PROOF: MobileBetaCiProof = {
  ...
  commit: "0f60c22",
  duration: "2m50s",
  proofUrl: "https://github.com/ApolloDNR/WoofWatcher/actions/runs/28685693291",
  passedSteps: [
    "Setup pnpm",
    "Setup Node",
