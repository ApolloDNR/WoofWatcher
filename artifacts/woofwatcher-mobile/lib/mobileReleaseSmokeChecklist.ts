  ...
  return {
    ...
    items: [
      ...
      },
      {
        ...
        detail:
          "Home, Log, Plans, Health, More, Pack, Story, Adventure, Records, Avatar Studio, and Care Pass must open without dead ends.",
        ...
        items: [
          {
            ...
            proof:
              "Attach iOS or Android proof that Report History says Saved on this device, or Ready to upload only after structured provider storage proof is attached, before handoff.",
            status: "required",
          },
          {
          ...
          },
          {
            ...
            detail:
              "Open /care-twin-qa?qaSurface=route-visual-consistency and capture Home, Log, Plans, Health, More, Pack, Story, and Records on iOS and Android with route-named file names or URIs.",
            proof:
              "Attach 8 route-named iOS screenshots and 8 route-named Android screenshots plus the QA note; examples include Home-iOS, Home-Android, Log-iOS, Log-Android, Plans-iOS, Plans-Android, Health-iOS, Health-Android, More-iOS, More-Android, Pack-iOS, Pack-Android, Story-iOS, Story-Android, Records-iOS, and Records-Android. Web preview screenshots do not replace native proof.",
            status: "required",
          },
        ],
      },
