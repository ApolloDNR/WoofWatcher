...
export const CARE_TWIN_SPRITE_MANIFEST: Record<CareTwinSpriteAction, CareTwinSpriteTrack> = {
  ...
  "ear-perk": {
    ...
    anchor: "bottom-center",
    slotSize: 256,
    requiredAsset: "assets/avatar/phoenix/candidates/option-b-ear-perk-strip.png",
    fallbackAnimation: "idle",
  ...
  "eat-loop": {
    ...
    anchor: "bottom-center",
    slotSize: 256,
    requiredAsset: "assets/avatar/phoenix/candidates/option-b-eat-loop-strip.png",
  ...
  "drink-loop": {
    ...
    anchor: "bottom-center",
    slotSize: 256,
    requiredAsset: "assets/avatar/phoenix/candidates/option-b-drink-loop-strip.png",
  ...
  "sleep-loop": {
    ...
    anchor: "bottom-center",
    slotSize: 256,
    requiredAsset: "assets/avatar/phoenix/candidates/option-b-sleep-loop-strip.png",
  ...
  "comfort-loop": {
    ...
    anchor: "bottom-center",
    slotSize: 256,
    requiredAsset: "assets/avatar/phoenix/candidates/option-b-comfort-loop-strip.png",
  ...
  "celebrate-hop": {
    ...
    anchor: "bottom-center",
    slotSize: 256,
    requiredAsset: "assets/avatar/phoenix/candidates/option-b-celebrate-hop-strip.png",
  ...
  "health-watch": {
    ...
    anchor: "bottom-center",
    slotSize: 256,
    requiredAsset: "assets/avatar/phoenix/candidates/option-b-health-watch-strip.png",
    fallbackAnimation: "comfort",
  ...
  "bark-loop": {
    ...
    anchor: "bottom-center",
    slotSize: 256,
    requiredAsset: "assets/avatar/phoenix/candidates/option-b-bark-reaction-strip.png",
    fallbackAnimation: "idle",
