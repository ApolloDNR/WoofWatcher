...
test("keys reminder focus by id, top padding, ordered rendered fields, and row count", () => {
  ...
  const baseRequest = {
    ...
    routeTopPadding: 72,
    sections,
    summary: "2 reminder candidates - 0 urgent, 1 watch.",
    alertCount: 0,
    watchCount: 1,
    totalCount: 2,
  };
...
test("coordinates focus once, rejects stale callbacks, clears on absence, and retries failed measurement", () => {
  ...
  const firstRequest = {
    ...
    routeTopPadding: 72,
    sections,
    summary: "2 reminder candidates - 0 urgent, 2 watch.",
    alertCount: 0,
    watchCount: 2,
    totalCount: 2,
...
test("focus lifecycle performs false-false-success retries without a rerender and then stays terminal", () => {
  const request = {
    ...
    summary: "1 reminder candidate - 0 urgent, 0 watch.",
    alertCount: 0,
    watchCount: 0,
    totalCount: 1,
  } satisfies PlanReminderFocusRequest;
...
test("focus lifecycle exhausts at three attempts until the key changes or focus becomes absent", () => {
  ...
  const baseRequest = {
    ...
    routeTopPadding: 72,
    sections,
    summary: "2 reminder candidates - 0 urgent, 0 watch.",
    alertCount: 0,
    watchCount: 0,
    totalCount: 2,
  } satisfies PlanReminderFocusRequest;
