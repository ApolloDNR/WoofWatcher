...
export const MOBILE_RELEASE_QA_SURFACES: readonly MobileReleaseQaSurface[] = [
  {
    ...
    verificationSteps: [
      "Open Phoenix Home from the canonical bottom navigation and confirm header, date, bell, and profile controls sit below the safe area.",
      ...
      "Scroll to Next Up and confirm the canonical bottom navigation does not cover the next action or quick-log controls.",
    ],
    acceptanceCriteria: [
      ...
      "The canonical bottom navigation never hides the next action, quick-log controls, or visible care status.",
    ],
    failureEscalation:
  ...
  },
  {
    ...
    devicePrompt:
      "On small iOS and Android phones, confirm the compact mission deck stays readable above the canonical bottom navigation, has no text overflow, and routes pending meal, walk/alone, Adventure, Health, and Care Pass rows correctly.",
    setupSteps: [
      "Use a local preview household with Phoenix sample care data.",
    ...
    verificationSteps: [
      ...
      "Tap Show more from today and confirm at least three mission rows are readable, reachable, and clear of the canonical bottom navigation.",
    ...
    acceptanceCriteria: [
      "No mission row is hidden behind the canonical bottom navigation or clipped by the phone viewport.",
    ...
    requiredEvidence: [
      ...
      "Android screenshot of the compact Home mission deck with the canonical bottom navigation visible.",
    ...
    launchRisk:
      "If the mission deck overflows, hides behind the bottom navigation, or routes to dead ends, the flagship Home screen loses the planned premium care-command feel.",
  },
  {
    ...
    route: "/",
    priority: "launch-critical",
    goal: "Prove a real owner can move through the main beta loop without dead ends: Home, Log, Plans, Health, More, Pack, Story, Adventure, Records, Avatar Studio, and Care Pass.",
    devicePrompt:
      "Run the bottom-nav owner preview on iOS and Android: visit Home, Log, Plans, Health, and More as primary tabs; open Pack, Story, and Records as deep routes; log one safe care event; open Launch Readiness and Adventure Mode; and confirm Care Pass and Avatar Studio remain reachable.",
    setupSteps: [
      "Use local preview data with no private real household details visible.",
      "Start on Home with the canonical bottom navigation visible.",
      "Keep provider, payment, storage, AI, and store gates in their truthful blocked or staged state.",
    ],
    verificationSteps: [
      "Open Home, Log, Plans, Health, and More in order from the canonical bottom navigation.",
      "Open Pack, Story, and Records from More, then confirm each deep route returns to the primary navigation without a dead end.",
      ...
      "In Plans, confirm upcoming care rows are readable and the add/edit flow is reachable without covering the bottom navigation.",
      ...
      "Open Health from the Home header bell or More, then confirm Health Watch and Bile Watch, plus the Review packet, Vet-share checklist, and Draft vet questions action stay non-diagnostic and readable on the phone.",
    ...
    acceptanceCriteria: [
      ...
      "Home, Log, Plans, Health, More, Pack, Story, Adventure Mode, Records, Avatar Studio, and Care Pass each expose a clear next action.",
    ...
    failureEscalation:
      "Mark Needs tune if any core route is confusing, clipped by the bottom navigation, blocked by keyboard/modal overlap, missing a next action, Adventure Mode becomes a dead end, or claims provider/store/payment/AI/storage readiness that is not actually configured.",
    requiredEvidence: [
      ...
      "Note confirming Home, Log, Plans, Health, More, Pack, Story, Adventure Mode, Records, Avatar Studio, and Care Pass were reachable without dead ends.",
    ...
    routeChecklist: [
      {
        ...
        route: "/",
        expected:
          "Confirm Phoenix status, next care, quick actions, and long-press-to-Studio are readable above the canonical bottom navigation.",
      },
      {
        label: "Log",
        route: "/log",
      ...
      },
      {
        ...
        route: "/health",
        expected:
          "Open Health from the Home header bell or More, then review Health Watch and Bile Watch copy for readable, non-diagnostic language.",
      },
      {
        label: "More",
        route: "/more",
        expected:
          "Open More from the canonical bottom navigation, then open Launch Readiness and confirm beta/public launch boundaries stay truthful.",
  ...
  },
  {
    ...
    acceptanceCriteria: [
      "Auth gateway and Setup are readable, tappable, and clear of safe-area, keyboard, and bottom-navigation issues on iOS and Android.",
  ...
  },
  {
    ...
    devicePrompt:
      "Run Home, Log, Plans, Health, More, Pack, Story, and Records on a small iOS and Android phone. Check the same screen recipe on each route: pixel stage, command board, primary action, safe bottom nav, and no overlapping text.",
    setupSteps: [
      ...
      "Open Home, Log, Plans, Health, and More from the canonical bottom navigation; open Pack, Story, and Records from visible in-app links, not through a hidden debug path.",
      "Name or save each screenshot with the route label and platform before attaching it so the proof manifest can match Home-iOS through Records-Android evidence.",
    ],
    verificationSteps: [
      "Open Home and confirm the compact Phoenix room, Quick Log, Next Up, Care Sense, and collapsed secondary modules read as one command center.",
    ...
    acceptanceCriteria: [
      ...
      "Home, Log, Plans, Health, More, Pack, Story, and Records use the same board anatomy, compact section headers, and route-to-route spacing rhythm.",
    ...
    requiredEvidence: [
      ...
      "Route-named file names or URIs for every attachment, such as Home-iOS, Home-Android, Log-iOS, Log-Android, Plans-iOS, Plans-Android, Health-iOS, Health-Android, More-iOS, More-Android, Pack-iOS, Pack-Android, Story-iOS, Story-Android, Records-iOS, and Records-Android.",
    ...
    routeChecklist: [
      {
        ...
        route: "/",
        expected:
          "The compact Phoenix room, Quick Log, Next Up, Care Sense, and collapsed secondary modules read as one planned first screen.",
        requiredNativePlatforms: ["ios", "android"],
      },
      {
        label: "Log",
