...
function buildAssistantContext(state: CareState) {
  ...
  return {
    ...
    healthWatch: {
      ...
      label:
        healthWatch.status === "good" ? "No concerns" : healthWatch.summary,
    ...
    handoff: {
      ...
      lastMeal,
      lastWalk,
      followUps: state.entries
        .filter((e) => e.severity === "watch" || e.severity === "urgent")
        .slice(0, 3),
...
export default function WoofGuideScreen() {
  ...
  const promptParam = Array.isArray(routeParams.prompt)
    ? routeParams.prompt[0]
    : routeParams.prompt;
              ...
              <View style={s.emptyArea}>
                  ...
                  <View
                    style={[
                      s.guideDock,
                      {
                        ...
                        borderTopColor: colors.brandNavy + "33",
                      },
                    ]}
                  >
                    <View
                      ...
                      <View
                        style={[
                          s.guideBoundaryCard,
                          {
                            ...
                            borderColor: colors.brandNavy + "55",
                          },
                        ]}
                      >
                        <Text
                ...
                <BoardCard enter={1} style={s.guideIntroCard}>
                  <View style={s.guideIntroRow}>
                    ...
                    <View style={s.guideIntroText}>
                      ...
                      >
                        Uses {name}'s logs for owner-reviewed, non-diagnostic
                        next steps.
                      </Text>
                    </View>
                  </View>
                ...
                {ASSISTANT_GATE.enabled ? (
                  ...
                  <BoardCard style={s.quickQuestionBoard}>
                    <BoardSectionHeader
                      ...
                      accessory={
                        <BoardPill
                          label={ASSISTANT_GATE.statusLabel}
                          tone={colors.amber}
                        />
                      }
                    />
                ...
                <BoardCard enter={2} style={s.actionBoard}>
                  <BoardSectionHeader
                    ...
                    accessory={
                      <BoardPill label="Owner reviewed" tone={colors.amber} />
                    }
                  />
        ...
        {ASSISTANT_GATE.enabled ? (
          ...
          >
            <TextInput
              ...
              placeholder={buildWoofGuideComposerPlaceholder(
                state.profile.name,
              )}
