...
export function summarizeReportArtifacts(
  ...
  const fallback: ReportArtifactSummary = {
    ...
    audienceLine: "Audience prep appears after local report sources are saved; provider-backed sharing remains gated.",
  ...
  return {
    ...
    audienceLine: "Pick the handoff audience first: sitter, trainer, caregiver, or vet context may need different notes before sharing.",
