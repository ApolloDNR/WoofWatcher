- [WoofWatcher living avatar](woofwatcher-avatar.md) — dog stays STILL; swap emotion scene via cross-fade, animate only ambient bg; mood images via AvatarContext; new pixel art needs @2x/@3x via upscale script.
